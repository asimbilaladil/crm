                        ...
                        echo '<br><div class="form-group">
                            ...
                            if ($question['type'] == 'multi') {
                                foreach ($question['multiQuestions'] as $item) {
                                    echo ' <div class="col-md-3 col-xs-3"></div><div class="form-group"> <input class="iradio" type="radio" name="answer_'. $count .'" value="'. $item .'"> '. $item .' </input> </div>';
                                }
                            //text
                            } else {
                                echo '<div class="form-group"><div class="col-md-6 col-xs-12"> <input type="text" name="answer_'. $count .'" /></div> </div>';
                            }
                        }
                    ?>
